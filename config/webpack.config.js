...
const basePath = `${process.env.PUBLIC_URL_DIST}`;
...
module.exports = function (webpackEnv) {
  ...
  return {
    ...
    output: {
      ...
      filename: isEnvProduction ? `${basePath}static/js/[name].[contenthash:8].js` : isEnvDevelopment && `${basePath}static/js/bundle.js`,
      // There are also additional JS chunk files if you use code splitting.
      chunkFilename: isEnvProduction ? `${basePath}static/js/[name].[contenthash:8].chunk.js` : isEnvDevelopment && `${basePath}static/js/[name].chunk.js`,
      assetModuleFilename: `${basePath}static/media/[name].[hash][ext]`,
    ...
    resolve: {
      ...
      alias: {
        ...
        ...(() => {
          const tsConf = require(path.resolve(__dirname, '../tsconfig.json')).compilerOptions.paths;
          const alias = {};
          Object.keys(tsConf).forEach((key) => {
            alias[key.replace('/*', '')] = path.resolve(__dirname, '../', tsConf[key][0].replace('/*', ''));
          });
          return alias;
        })(),
      },
          ...
          oneOf: [
            ...
            },
            {
              ...
              use: [
                ...
                },
                {
                  ...
                  options: {
                    name: `${basePath}static/media/[name].[hash].[ext]`,
                  },
                },
              ],
              issuer: {
            ...
            // extensions .module.scss or .module.sass
            {
              ...
              use: getStyleLoaders(
                ...
                'sass-loader',
                {
                  additionalData: '@import "_src/assets/style/var.scss";',
                },
              ),
              // Don't consider CSS imports dead code even if the
              // containing package claims to have no side effects.
    ...
    plugins: [
      ...
      isEnvProduction &&
        new MiniCssExtractPlugin({
          ...
          filename: `${basePath}static/css/[name].[contenthash:8].css`,
          chunkFilename: `${basePath}static/css/[name].[contenthash:8].chunk.css`,
        }),
